...
const testimonials = [
  {
    name: "Dipu Pandey",
    role: "Senior DAssociate at dice Accademy and founder of Dice Accademy",
    review:
      "Dilkash Alam is a visionary developer. His attention to detail and creativity blew us away. Our project was a massive success because of him.",
    image: m1, // Points to imported image
  },
  {
    name: "Tanay Saxena",
    role: "Full Stack Developer at CodeEmpire",
    review:
      "Working with Dilkash Alam was an absolute pleasure. He brings design and code together like magic. Highly recommend him!",
    image: w1,
  },
  {
    name: "Ashish",
    role: "Software Engineer at Amazon and teacher at Dice Accademy",
    review:
      "From concept to execution, Dilkash Alam handled everything flawlessly. His work ethic and innovation are unmatched.",
    image: m2,
  },
  {
    name: "Shashank Sharma",
    role: "Head of Accademy at Dice Accademy and ui/ux designer",
    review:
      "Dilkash Alam transformed our outdated platform into something modern and powerful. His skills are world-class.",
    image: w2,
  },
];
